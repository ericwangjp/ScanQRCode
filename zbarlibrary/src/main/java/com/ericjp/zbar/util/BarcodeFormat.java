...
import com.ericjp.zbar.zbar.Symbol;
 ...
 * -----------------------------------------------------------------
 * desc:  一维条码、二维码各种类型简介 https://blog.csdn.net/xdg_blog/article/details/52932707
 *  在线生成各种码 https://barcode.tec-it.com/zh/
 * Author: wangjp
 * Email: wangjp1@fosun.com
 * Version: Vx.x.x
 * Create: 2019-11-03 21:13
 */
...
//        ALL_FORMAT_LIST.add(BarcodeFormat.DATABAR);
    ...
    public static final List<BarcodeFormat> ONE_DIMENSION_FORMAT_LIST = new ArrayList<>();
...
//        ONE_DIMENSION_FORMAT_LIST.add(BarcodeFormat.DATABAR);
    ...
    public static final List<BarcodeFormat> TWO_DIMENSION_FORMAT_LIST = new ArrayList<>();
    ...
    public static final List<BarcodeFormat> HIGH_FREQUENCY_FORMAT_LIST = new ArrayList<>();
