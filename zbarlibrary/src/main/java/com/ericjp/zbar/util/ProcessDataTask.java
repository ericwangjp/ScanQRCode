...
public class ProcessDataTask extends AsyncTask<Void, Void, ScanResult> {
    ...
    public ProcessDataTask(Camera camera, byte[] data, QRCodeView qrCodeView, boolean isPortrait) {
        mCamera = camera;
        mData = data;
    ...
    public ProcessDataTask(String picturePath, QRCodeView qrCodeView) {
