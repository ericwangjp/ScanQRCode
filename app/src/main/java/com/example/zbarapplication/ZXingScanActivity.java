...
import com.ericjp.zbar.zxing.ZXingView;

public class ZXingScanActivity extends AppCompatActivity implements QRCodeView.Delegate, View.OnClickListener {

    private ZXingView mZXingView;
    private static final String TAG = "ZXingScanActivity";
    private int REQUEST_CODE_CHOOSE_QRCODE_FROM_GALLERY = 1100;
...
//        mZXingView.startCamera(Camera.CameraInfo.CAMERA_FACING_FRONT); // 打开前置摄像头开始预览，但是并未开始识别
    ...
    public void onScanQRCodeOpenCameraError() {
        Toast.makeText(this, "无法打开摄像头，请检查是否有相关权限", Toast.LENGTH_SHORT).show();
        Log.e(TAG, "打开相机出错");
    }
...
//                startActivityForResult(photoPickerIntent, REQUEST_CODE_CHOOSE_QRCODE_FROM_GALLERY);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == REQUEST_CODE_CHOOSE_QRCODE_FROM_GALLERY) {
            if (data != null) {
                final String picturePath = QRCodeUtil.getImagePath(ZXingScanActivity.this, data);
...
//            }.execute();
                ...
                Toast.makeText(ZXingScanActivity.this, "获取图片路径失败", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
